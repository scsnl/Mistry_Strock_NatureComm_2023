...
def main(args):
    ...
    idx = loadmat(f'{os.environ.get("OAK")}/projects/percym/2021_DNN_1_9/results/dnn/dnn_astrock_31Jan2022/SPON_only_Sep2022.mat')['SPONIPS']-1
    spontaneous[idx] = 1
    ...
    np.save(f'{accuracy_path}/spontaneousv2_epochs_{epochs}_accuracy.npy', epoch_accuracy)
