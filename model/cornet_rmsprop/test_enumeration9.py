...
def main(args):
    ...
    activity_path = f'{os.environ.get("DATA_PATH")}/enumeration_{n_max}/activity/cornet_rmsprop'
    # path where accuracies are saved
    accuracy_path = f'{os.environ.get("DATA_PATH")}/enumeration_{n_max}/accuracy/cornet_rmsprop'
    ...
    model_path = f'{os.environ.get("DATA_PATH")}/enumeration_{n_max}/model/cornet_rmsprop'
