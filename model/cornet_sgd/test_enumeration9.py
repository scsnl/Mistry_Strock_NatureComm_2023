...
def main(args):
    ...
    activity_path = f'{os.environ.get("DATA_PATH")}/enumeration_{n_max}/activity/cornet_sgd'
    # path where accuracies are saved
    accuracy_path = f'{os.environ.get("DATA_PATH")}/enumeration_{n_max}/accuracy/cornet_sgd'
