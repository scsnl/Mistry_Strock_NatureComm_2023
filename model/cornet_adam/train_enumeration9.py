...
model  = ExtendedCORnet(out_features = n_max, lr = 1e-3, optimizer = 'adam')
...
trainer = pl.Trainer(default_root_dir = log_path, callbacks = [gpu_stats, checkpoint], deterministic = True, accelerator='gpu', devices=4, strategy = "ddp", num_nodes = 1, max_epochs=n_epoch)
